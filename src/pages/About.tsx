  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <link rel="canonical" href={aboutMetadata.alternates.canonical} />
        {/* Open Graph */}
        ...
        <meta property="og:image" content={aboutMetadata.openGraph.images[0].url} />
        <meta property="og:image:alt" content={aboutMetadata.openGraph.images[0].alt} />
        <meta property="og:url" content={aboutMetadata.openGraph.url} />
        <meta property="og:type" content={aboutMetadata.openGraph.type} />
        <meta property="og:site_name" content={aboutMetadata.openGraph.siteName} />
        {/* Twitter */}
        <meta name="twitter:card" content={aboutMetadata.twitter.card} />
        <meta name="twitter:title" content={aboutMetadata.twitter.title} />
        <meta name="twitter:description" content={aboutMetadata.twitter.description} />
        <meta name="twitter:image" content={aboutMetadata.twitter.images[0]} />
        <meta name="twitter:creator" content={aboutMetadata.twitter.creator} />
        <meta name="twitter:site" content={aboutMetadata.twitter.site} />
        {/* Structured Data */}
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            logo: 'https://colorsnap.design/favicon-512x512.png',
            description:
              'ColorSnap is a free, privacy-first online tool for extracting color palettes from images, designed for developers and designers.',
            sameAs: [
              'https://twitter.com/ColorSnapDesign',
              'https://www.linkedin.com/company/colorsnap',
              'https://github.com/colorsnap',
              'https://www.producthunt.com/products/colorsnap',
            ],
            contactPoint: {
              '@type': 'ContactPoint',
              contactType: 'customer service',
              url: 'https://colorsnap.design/contact',
              email: 'support@colorsnap.design',
            },
          })}
        </script>
      </Helmet>
